        ...
        'self-identity': `
            <div style="display: grid; grid-template-columns: 1fr 1fr; column-gap: 30px;">
                <div>
                    ...
                    <img src="students/강민석/강민석_Self Identity01.png" alt="Self Identity 01" style="height: 1400px; margin-top: 10px; object-position: top;">
                </div>
                <div>
                    <img src="students/강민석/강민석_Self Identity02.png" alt="Self Identity 02" style="height: 1400px; margin-top: 90px; object-position: top;">
                </div>
            </div>
        `
    },
