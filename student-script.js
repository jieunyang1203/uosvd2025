    ...
    '류시완': {
        'self-identity': `
            <div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; column-gap: 30px; row-gap: 10px;">
                    <img src="students/류시완/SelfIdentity_류시완_1.jpg" alt="Self Identity 1">
        ...
        'generative-system': `
            <div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; column-gap: 30px; row-gap: 10px;">
                    ...
                    <img src="students/류시완/GenerativeSystem_류시완_2.jpg" alt="Generative System 2">
                </div>
            </div>
        `,
        'shape-poster': `
            <div>
                ...
                <video src="students/류시완/ShapePoster_류시완.mp4" aria-label="Shape Poster" autoplay muted loop playsinline webkit-playsinline preload="metadata" style="width: 50%;"></video>
            </div>
        `,
        'collected-book': `
            <div>
                <p style="word-break: keep-all; line-height: 1.5; margin-bottom: 30px;">엮어만든 악보: 보지 않고도 연주가 가능한 악보를 자르고 엮어서 새로운 책을 제작했다.</p>
                <video src="students/류시완/CollectedBook_류시완.mp4" aria-label="Collected Book" autoplay muted loop playsinline webkit-playsinline preload="metadata" style="width: 50%;"></video>
            </div>
        `
    },
    '노희지': {
        'self-identity': `
            <div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; column-gap: 30px; row-gap: 10px;">
                    ...
                    <img src="students/노희지/selfIdentity_사진3_노희지.jpg" alt="Self Identity 3" style="height: auto;">
                    <img src="students/노희지/selfIdentity_사진4_노희지.jpg" alt="Self Identity 4" style="height: auto;">
                </div>
            </div>
        `
    },
        ...
        'generative-system': `
            <div>
                ...
                <div style="display: grid; grid-template-columns: repeat(5, 1fr); column-gap: 20px; row-gap: 10px;">
                    <img src="students/서정민/저너레이티브/gen1.jpg" alt="Gen 1">
                    <img src="students/서정민/저너레이티브/gen2.jpg" alt="Gen 2">
                    <img src="students/서정민/저너레이티브/gen3.jpg" alt="Gen 3">
                    <img src="students/서정민/저너레이티브/gen4.jpg" alt="Gen 4">
                    <img src="students/서정민/저너레이티브/gen5.jpg" alt="Gen 5">
                    <img src="students/서정민/저너레이티브/gen6.jpg" alt="Gen 6">
                    <img src="students/서정민/저너레이티브/gen7.jpg" alt="Gen 7">
                    <img src="students/서정민/저너레이티브/gen8.jpg" alt="Gen 8">
                    <img src="students/서정민/저너레이티브/gen9.jpg" alt="Gen 9">
                    <img src="students/서정민/저너레이티브/gen10.jpg" alt="Gen 10">
                    <img src="students/서정민/저너레이티브/gen11.jpg" alt="Gen 11">
                    <img src="students/서정민/저너레이티브/gen12.jpg" alt="Gen 12">
                    <img src="students/서정민/저너레이티브/gen13.jpg" alt="Gen 13">
        ...
        'self-identity': `
            <div>
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); column-gap: 30px; row-gap: 10px;">
                    ...
                    <img src="students/유성헌/SelfIdentity_사진2_유성헌.jpg" alt="Self Identity 2">
                    <img src="students/유성헌/SelfIdentity_사진3_유성헌.jpg" alt="Self Identity 3">
                    <img src="students/유성헌/SelfIdentity_사진4_유성헌.jpg" alt="Self Identity 4">
                    <img src="students/유성헌/SelfIdentity_사진5_유성헌.jpg" alt="Self Identity 5">
                </div>
            </div>
        `
    },
        ...
        'shape-poster': `
            <div>
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); column-gap: 30px; row-gap: 10px;">
                    ...
                    <img src="students/윤다경/ShapePoster_사진3_윤다경.jpg" alt="Shape Poster 3">
                </div>
            </div>
        `
    },
    ...
    '이한나': {
        ...
        'mapping-your-time': `
            <div>
                ...
                <img src="students/이한나/맵핑유얼타임_1_이한나.jpg" alt="Mapping Your Time">
            </div>
        `,
        'generative-system': `
            <div>
                ...
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); column-gap: 30px; row-gap: 10px;">
                    <img src="students/이한나/제너러티브_1_이한나.jpg" alt="Generative System 1">
                    <img src="students/이한나/제너러티브_1_이한나(1).jpg" alt="Generative System 2">
                    <img src="students/이한나/제너러티브_4_이한나.jpg" alt="Generative System 3">
                    <img src="students/이한나/제너러티브_5_이한나.jpg" alt="Generative System 4">
                    <img src="students/이한나/제너러티브_13_이한나.jpg" alt="Generative System 5">
                </div>
            </div>
        `,
        'shape-poster': `
            <div>
                ...
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); column-gap: 30px; row-gap: 10px;">
                    <img src="students/이한나/쉐입포스터_1_이한나.jpg" alt="Shape Poster 1">
                    <img src="students/이한나/쉐입포스터_2_이한나.jpg" alt="Shape Poster 2">
                    <img src="students/이한나/쉐입포스터_3_이한나.jpg" alt="Shape Poster 3">
        ...
        'generative-system': `
            <div>
                ...
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); column-gap: 30px; row-gap: 10px;">
                    ...
                    <img src="students/장민지/gen2.jpg" alt="Generative System 2">
        ...
        'shape-poster': `
            <div>
                ...
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); column-gap: 30px; row-gap: 10px;">
                    ...
                    <img src="students/장민지/Shape Poster_4_장민지.jpg" alt="Shape Poster 4">
                    <img src="students/장민지/Shape Poster_5_장민지.jpg" alt="Shape Poster 5">
                </div>
            </div>
        `
    },
    '장혜원': {
        'self-identity': `
            <div>
                ...
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); column-gap: 30px; row-gap: 10px;">
                    ...
                    <img src="students/장혜원/self-identity_사진4_장혜원.jpg" alt="Self Identity 4">
                </div>
            </div>
        `,
        'mapping-your-time': `
        ...
        'generative-system': `
            <div>
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); column-gap: 30px; row-gap: 10px;">
                    <img src="students/장혜원/gen1.jpg" alt="Generative System 1">
                    <img src="students/장혜원/gen2.jpg" alt="Generative System 2">
        ...
        'generative-system': `
            <div>
                ...
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); column-gap: 30px; row-gap: 10px;">
                    ...
                    <img src="students/최문형/Generative System_사진3_최문형.jpg" alt="Generative System 3" loading="lazy">
                    <img src="students/최문형/Generative System_사진4_최문형.jpg" alt="Generative System 4" loading="lazy">
                    <img src="students/최문형/Generative System_사진5_최문형.jpg" alt="Generative System 5" loading="lazy">
                    <img src="students/최문형/Generative System_사진6_최문형.jpg" alt="Generative System 6" loading="lazy">
                </div>
            </div>
        `,
        'shape-poster': `
        ...
        'collected-book': `
            <div>
                ...
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); column-gap: 30px; row-gap: 10px;">
                    ...
                    <img src="students/최문형/Collected Book_사진3_최문형.jpg" alt="Collected Book 3" loading="lazy">
                </div>
            </div>
        `
    },
...
// Per-student section side overrides (force a section to left/right of the zigzag)
const sectionSideOverrides = {
    '이시네': { 'self-identity': 'right' },
    '이정은': { 'shape-poster': 'right', 'generative-system': 'left' }
};
if (sectionSideOverrides[currentStudent.name]) {
    const overrides = sectionSideOverrides[currentStudent.name];
    Object.keys(overrides).forEach(projectId => {
        const section = document.getElementById(projectId);
        if (section) {
            section.classList.add(overrides[projectId] === 'right' ? 'force-right' : 'force-left');
        }
    });
}
...
document.addEventListener('keydown', (e) => {
    ...
    // Arrow keys navigate between students (when the image modal is closed)
